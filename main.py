...
#         # atualizar o atributo do jogador (corrige typo / sincroniza estado)
#         self.jogador.tempo_inicial_invencivel = time.time()
...
#         invencivel_spawn = (now - self.jogador.tempo_inicial_invencivel) < INVULNERABILIDADE_INICIAL
...
#     try:
#         jogo = JogoEco()
#         # garante que iniciamos no MENU (ou mude para JOGANDO se preferir pular o menu)
#         jogo.estado = EstadoJogo.MENU
#         jogo.rodar()
#     except SystemExit:
#         # saída esperada (quando o usuário fecha a janela)
#         raise
#     except Exception:
#         print("[ERROR] exceção não tratada no main:")
#         traceback.print_exc()
#         try:
#             pygame.quit()
#         except Exception:
...
"""
main.py - ECO aprimorado - itens destacados + dano menos repentino
